...
const packOfPictures = document.querySelector(".gallery");
...
const markUp = imageTemplate();

packOfPictures.insertAdjacentHTML("afterbegin", markUp);

// console.log(markUp)
// images.forEach(function(image){
//   const liForPictures=document.createElement('li')
//   const imgCreation=document.createElement('img');
//   imgCreation.src=image.url;
//   imgCreation.alt=image.alt;
//   liForPictures.appendChild(imgCreation);
// })
// console.log(liForPictures)
